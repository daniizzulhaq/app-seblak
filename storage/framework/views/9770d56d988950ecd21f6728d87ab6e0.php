        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2"
                ...
                <div class="relative overflow-hidden">
                    <img src="<?php echo e($product->gambar ? Storage::url($product->gambar) : 'https://via.placeholder.com/400x300'); ?>"
                         alt="<?php echo e($product->nama_alat); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\windows\Documents\joki skripsi\joki laporan\web\e-coomerce-seblak\resources\views/home.blade.php ENDPATH**/ ?>