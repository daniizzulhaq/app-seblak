    ...
    <div class="flex items-center justify-between">
        ...
        <div class="hidden md:block">
            <div class="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-4">
                <p class="text-sm font-medium"><?php echo e(date('d F Y')); ?></p>
            </div>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-l-4 border-indigo-500">
        ...
        <div>
            ...
            <p class="text-4xl font-bold text-gray-900 mb-1"><?php echo e($totalProducts); ?></p>
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-l-4 border-green-500">
        ...
        <div>
            ...
            <p class="text-4xl font-bold text-gray-900 mb-1"><?php echo e($totalTransactions); ?></p>
            <p class="text-xs text-gray-400">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-l-4 border-blue-500">
        ...
        <div>
            ...
            <p class="text-4xl font-bold text-gray-900 mb-1"><?php echo e($totalCustomers); ?></p>
            <p class="text-xs text-gray-400">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 border-l-4 border-yellow-500">
        ...
        <div>
            ...
            <p class="text-3xl font-bold text-gray-900 mb-1">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></p>
            <p class="text-xs text-gray-400">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-6">
            <?php if($recentTransactions->count() > 0): ?>
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <p class="font-semibold text-gray-900"><?php echo e($transaction->transaction_code); ?></p>
                        ...
                        <div class="text-right">
                            <p class="font-bold text-indigo-600 mb-2">Rp <?php echo e(number_format($transaction->total_amount, 0, ',', '.')); ?></p>
                            <span class="text-xs px-3 py-1 rounded-full font-semibold
                                <?php if($transaction->status == 'pending'): ?> bg-yellow-100 text-yellow-700
                                <?php elseif($transaction->status == 'completed'): ?> bg-green-100 text-green-700
                ...
                <a href="<?php echo e(route('admin.transactions.index')); ?>" class="flex items-center justify-center mt-6 text-indigo-600 hover:text-indigo-700 font-semibold hover:bg-indigo-50 py-3 rounded-lg transition-colors duration-200">
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="p-6">
            <?php if($lowStockProducts->count() > 0): ?>
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <p class="font-semibold text-gray-900"><?php echo e($product->nama_alat); ?></p>
                                <p class="text-sm text-gray-500 flex items-center mt-1">
                                    <i class="fas fa-map-marker-alt text-xs mr-1"></i>
                                    <?php echo e($product->daerah->nama_daerah); ?>
                        ...
                        <div class="text-right">
                            <span class="px-4 py-2 rounded-lg font-bold text-sm inline-flex items-center
                                <?php echo e($product->stok == 0 ? 'bg-red-100 text-red-700' : 'bg-yellow-100 text-yellow-700'); ?>">
                ...
                <a href="<?php echo e(route('admin.alat-musik.index')); ?>" class="flex items-center justify-center mt-6 text-orange-600 hover:text-orange-700 font-semibold hover:bg-orange-50 py-3 rounded-lg transition-colors duration-200">
                    Kelola Produk
                    <i class="fas fa-arrow-right ml-2"></i>
                </a>
            <?php else: ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\windows\Documents\joki skripsi\joki laporan\web\e-coomerce-seblak\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>