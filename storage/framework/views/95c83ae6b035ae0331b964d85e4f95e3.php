...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-2xl shadow-xl p-6 mb-10 border border-gray-100">
        <form method="GET" action="<?php echo e(route('catalog.index')); ?>">
                ...
                <div class="relative">
                    ...
                    <select name="level_pedas_id" class="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300 appearance-none bg-white">
                        ...
                        <?php $__currentLoopData = $levelPedas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($level->id); ?>" <?php echo e(request('level_pedas_id') == $level->id ? 'selected' : ''); ?>>
            ...
            <div class="flex gap-3">
                ...
                <a href="<?php echo e(route('catalog.index')); ?>" class="bg-gray-100 text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-200 transition-all duration-300 flex items-center">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-2">
                ...
                <p class="text-gray-700 font-medium">
                    Menampilkan <span class="font-bold text-red-600"><?php echo e($produks->count()); ?></span> dari 
                    <span class="font-bold text-red-600"><?php echo e($produks->total()); ?></span> produk
                </p>
            </div>
        </div>
    <?php endif; ?>
    ...
    <?php if($produks->count() > 0): ?>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <?php $__currentLoopData = $produks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                <div class="relative overflow-hidden">
                    <img src="<?php echo e($product->gambar ? asset('storage/' . $product->gambar) : 'https://via.placeholder.com/400x300'); ?>" 
                ...
                <div class="p-5">
                    ...
                    <div class="space-y-2 mb-4">
                        ...
                        <div class="flex items-center text-sm text-gray-600">
                            ...
                            <span class="truncate"><?php echo e($product->levelPedas->nama_level ?? '-'); ?></span>
                        </div>
                        ...
                        <div class="flex items-center text-sm text-gray-600">
                            ...
                            <span class="truncate"><?php echo e($product->kategori->nama_kategori ?? '-'); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="flex items-end justify-between mb-4">
                        ...
                        <div class="text-right">
                            ...
                            <p class="text-sm font-bold <?php echo e($product->stok > 0 ? 'text-green-600' : 'text-red-600'); ?>">
                                <?php echo e($product->stok); ?> unit
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-2">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <?php endif; ?>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="bg-gray-100 text-gray-700 px-4 py-3 rounded-xl hover:bg-red-100 hover:text-red-600 transition-all duration-300" title="Login untuk Membeli">
                                <i class="fas fa-shopping-cart"></i>
                            </a>
                        <?php endif; ?>
                    </div>
    ...
    <?php else: ?>
        <div class="text-center py-20 bg-white rounded-2xl shadow-lg">
            ...
            <a href="<?php echo e(route('catalog.index')); ?>" class="inline-block bg-gradient-to-r from-red-600 to-orange-600 text-white px-8 py-3 rounded-xl font-semibold hover:shadow-xl transform hover:scale-105 transition-all duration-300">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\windows\Documents\joki skripsi\joki laporan\web\e-coomerce-seblak\resources\views/catalog/index.blade.php ENDPATH**/ ?>