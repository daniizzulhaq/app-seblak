...
@section('title', 'Daftar Produk - Mamakoo')
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Total: {{ $produks->total() }} produk</p>
                    </div>
                </div>
                    ...
                    @forelse($produks as $index => $produk)
                        <tr class="hover:bg-orange-50 transition-colors duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-medium text-gray-900">{{ $produks->firstItem() + $index }}</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-2">
                                    <span class="text-sm text-gray-700">🌶️ {{ $produk->levelPedas->nama_level ?? '-' }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
        ...
        <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="text-sm text-gray-600">
                    Menampilkan <span class="font-semibold text-gray-900">{{ $produks->firstItem() }}</span>
                    sampai <span class="font-semibold text-gray-900">{{ $produks->lastItem() }}</span>
                    dari <span class="font-semibold text-gray-900">{{ $produks->total() }}</span> produk
                </div>
